...
section(6, "pazar", "06", "Pazar", "bg-2",
    ...
    [
        ...
        chart("funnel", "market-tam-sam-som", caption="Toplam pazardan ulaşılabilir hedefe"),
        statGrid(2, [
            stat("Toplam pazar (TAM)", ref="market.tam_try", tone="gold", sub="ortalama işlem değerine dayanır", tag=VAR),
            stat("Ulaşılabilir hedef gelir (medyan)", ref="revenue.median", tone="accent", sub="online arsa payı %10 · take rate {{metric:market.take_rate}}", tag=HED),
        ]),
